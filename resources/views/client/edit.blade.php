...
@section('page-title', __('Modifica cliente') )
...
<div class="row g-3 row-deck">
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                {!! Form::open(["route" => ["client.update", $customer->id], "method" => "PATCH", "id" => "submit-form", "enctype" => "multipart/form-data"]) !!}
                <div class="row mb-4">
                    <label class="col-xl-2 col-sm-3 col-form-label">{{ __('Cognome') }} *</label>
                    <div class="col-xl-8 col-sm-9">
                        {!! Form::text('first_name', $customer->first_name, ["class" => "form-control form-control-lg"]) !!}
                ...
                <div class="row mb-4">
                    ...
                    <div class="col-xl-8 col-sm-9">
                        {!! Form::text('last_name', $customer->last_name, ["class" => "form-control form-control-lg"]) !!}
                    </div>
                </div>
                <div class="row mb-4">
                    <label class="col-xl-2 col-sm-3 col-form-label">{{ __('Email:') }} *</label>
                    <div class="col-xl-8 col-sm-9">
                        {!! Form::email('email', $customer->email, ["class" => "form-control form-control-lg"]) !!}
                    </div>
                </div>
                <div class="row mb-4">
                    <label class="col-xl-2 col-sm-3 col-form-label">{{ __('Tel:') }} *</label>
                    <div class="col-xl-8 col-sm-9">
                        {!! Form::number('mobile_number', $customer->mobile_number, ["class" => "form-control form-control-lg"]) !!}
                    </div>
                </div>
                <div class="row mb-4">
                    <label class="col-xl-2 col-sm-3 col-form-label">{{ __('Documento:') }} *</label>
                    <div class="col-xl-8 col-sm-9">
                        {!! Form::text('document', $customer->document, ["class" => "form-control form-control-lg"]) !!}
                    </div>
                </div>
                <div class="row mb-4">
                    <label class="col-xl-2 col-sm-3 col-form-label">{{ __('Residenza:') }} *</label>
                    <div class="col-xl-8 col-sm-9">
                        {!! Form::text('residence', $customer->residence, ["class" => "form-control form-control-lg"]) !!}
                    </div>
                </div>
                <div class="row mb-4">
